...
META:
  ...
  OPERATOR_RULING::"Shaun Buswell, 2026-09-26, holistic-orchestrator session: (1) amend ADR-0013 in place + thin ruling record → yes; (2) adopt in-place amendment rule → yes, across the ecosystem; (3) open issue for propose_decision_amendment broker → yes (#189); (4) verbatim: 'No rule should be immutable. Everything is worth of change, especially if it goes throug the right review. Change isn't the issue. Proper governance is.'; (5) ratification, verbatim: 'Yes, add the ratified info from me.'"
  ...
  FIRST_APPLICATION::"ADR-0013 R1 COORDINATION_DOCUMENT class → proposed in PR #190[ADR-0013 v1.1 in-place edit ⊕ thin ruling record HO-ADR-0013-COORDINATION-DOCUMENT-CLASS-20260926]; this record's own in-place amendments of ADR-RFC-ARCH-002/004/005 are the first merged application"
  ...
  AMENDED_ARTEFACTS::".hestai/decisions/rfc-arch/ADR-RFC-ARCH-004-agent-readable-governance-records.md v1.1→v1.2, edited in place: §1.2 adds optional REVISION field, §1.6 adds in-place-amendment AMENDS reading, §0.2 intro reworded from immutable-in-PR-D-scope to fixed-inputs-amendable-via-governance[not added to this record's AMENDS list — ADR-RFC-ARCH-004 carries no TOKEN, lookup_token_deterministic resolves False]; .hestai/decisions/rfc-arch/ADR-RFC-ARCH-002-information-architecture-contract.md §0.2 intro + §7 'PE-immutable' line reworded from supersession-only/immutable framing to amendable-in-place-via-proper-governance, header gains a 2026-09-26 revision note, the three PE amendments themselves unchanged; .hestai/decisions/rfc-arch/ADR-RFC-ARCH-005-facet-abi-and-retrieval.md §0.2 intro reworded from immutable-in-PR-C-scope to fixed-inputs-amendable-via-governance[same TOKEN-less reasoning as ADR-004 — no AMENDS edge added]"
