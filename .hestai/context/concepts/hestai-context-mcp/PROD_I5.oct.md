...
AGENT::"Before adding any import or write to get_context.py, check PURITY_GUARD::G3. The function signature get_context(working_dir: str) is frozen under OPTION_C. Filesystem snapshot diff must be empty across any call (INVARIANT_001). Forbidden response keys: portable_state, restore_status, hydrated. Tests TEST_139..TEST_148 mechanically enforce all invariants. CE review required for any change to this file."
